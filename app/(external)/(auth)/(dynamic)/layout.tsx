...
const AuthLayout: FC<ILayoutProps> = ({ children }) => {
  return (
    <div className="flex justify-center items-center h-screen w-screen relative">
      <div className="container min-h-[360px] h-1/2 max-h-[500px] w-11/12 sm:w-auto rounded-2xl shadow-xl p-0 overflow-hidden border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-950">
        <div className="dark:bg-black text-foreground h-full p-5 px-3 sm:px-10 relative">
